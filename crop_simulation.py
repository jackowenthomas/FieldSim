...
class CropWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("Crop Simulator")#set the window title
        self.create_select_crop_layout()

        self.stacked_layout = QStackedLayout()#this holds the various layouts this windows needs
    ...
    def create_crop_view_layout(self,crop_type):
    ...
    def instantiate_crop(self):
        ...
        self.create_crop_view_layout(crop_type)#create the view crop growth layout
        self.stacked_layout.addWidget(self.view_crop_widget)
        self.stacked_layout.setCurrentIndex(1)#change the visible layout in the stacked
