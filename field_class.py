...
class Field:
    ...
    def grow(self,light,food,water):
        #grow the crops (light and water are available to all crops in same amont
            ...
            for animal in self._animals:
                ...
                #remove food for this animal from total
                    ...
                    if additional_food > 0:
                        #remove some additional food for this animals
                        additional_food -= 1
...
def manual_grow(field):
    ...
    while not valid:
        try:
            food = int(input("Please enter a food value between (1-100): "))
            if 1 <= food <= 100:
                valid = True
            else:
...
def display_animal_menu():
    ...
    print("2. Sheep")
    print()
    print("0. I don't want to add an animal - return me to main menu")
    print()
    print("Please select an option from the above menu")
